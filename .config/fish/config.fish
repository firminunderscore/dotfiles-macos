...
alias sig="python3 /Users/alexian/Code/Sigma/main.py" # Sigma tool alias
alias adbenq="~/Applications/ADBenQ/ADBenQ" # ADBenQ tool alias
alias xpr="z /Users/alexian/Library/Mobile Documents/com~apple~CloudDocs/Pro/Stage/XPR"
